...
# Copied from https://gist.github.com/maledorak/488c1bd0a6cca333c32c5289b841b9ef#file-dmenu_hotkeys-py and slighlty adapted
...
if __name__ == "__main__":
    ...
    if app not in SUPPORTED_APPS:
        ...
        print(f'hot_keys: {hot_keys}')
        print(f'hot_keys.output: {hot_keys.output}')
